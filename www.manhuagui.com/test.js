...
(function (a) {
    a.Jcrop = function (b, c) {
        ...
        B && (H = a("<img />").attr("src", D.attr("src")).css(z).width(E).height(F), I.append(H)),
            h && K.css({
                overflowY: "hidden"
            });
        var L = d.boundary,
        ...
        var Z = function () {
            function a() {
                ...
                try {
                    for (d = 0; d < b.length; d++) {
                        ...
                        e = "on" + e;
                        var f = e in c;
                        f || (c.setAttribute(e, "return;"), f = typeof c[e] == "function"),
                            a[b[d]] = f
                    }
            ...
            _ = function () {
                ...
                function m() {
                    ...
                    return h === 0 && (h = E * 10),
                        i === 0 && (i = F * 10),
                        n < f ? (s = e, t = m * f, r = j < 0 ? a - t : t + a, r < 0 ? (r = 0, u = Math.abs((r - a) / f), s = k < 0 ? b - u : u + b) : r > E && (r = E, u = Math.abs((r - a) / f), s = k < 0 ? b - u : u + b)) : (r = c, u = l / f, s = k < 0 ? b - u : b + u, s < 0 ? (s = 0, t = Math.abs((s - b) * f), r = j < 0 ? a - t : t + a) : s > F && (s = F, t = Math.abs(s - b) * f, r = j < 0 ? a - t : t + a)),
                        r > a ? (r - a < g ? r = a + g : r - a > h && (r = a + h), s > b ? s = b + (r - a) / f : s = b - (r - a) / f) : r < a && (a - r < g ? r = a - g : a - r > h && (r = a - h), s > b ? s = b + (a - r) / f : s = b - (a - r) / f),
            ...
            bb = function () {
                ...
                function E() {
                    h = !0;
                    if (d.allowResize) return J.show(),
                        !0
                }
                function F() {
                    h = !1,
            ...
            bc = function () {
                ...
                function i(a) {
                    return a.preventDefault(),
                        a.stopPropagation(),
                        W && (W = !1, c(m(a)), bb.isAwake() && d.onSelect.call(bs, u(_.getFixed())), g(), b = function () { },
                            c = function () { }),
                        !1
                }
                function j(a, d, e) {
        ...
        a.Jcrop.Loader = function (b, c, d) {
            ...
            var e = a(b),
                f = e[0];
            e.bind("load.jcloader", g).bind("error.jcloader",
                function (b) {
                    e.unbind(".jcloader"),
...
var Hashtable = function () {
    ...
    function p(e) {
        return function (t) {
            var n = t.length;
            for (var r = 0,
                i = this.entries.length; r < i; ++r) t[n + r] = this.entries[r][e]
        }
    }
    function d(e, t) {
        var n = e.length,
    ...
    return a.prototype = {
        ...
        getEntries: function (e) {
            var t = e.length;
            for (var n = 0,
                r = this.entries.length; n < r; ++n) e[t + n] = this.entries[n].slice(0)
        },
        containsKey: h(f),
...
window.Modernizr = function (n, t, i) {
    ...
    var g = "2.7.1",
        ...
        e,
        u;
    e = !s(h, "undefined") && !s(h.call, "undefined") ?
        function (n, t) {
            return h.call(n, t)
        } : function (n, t) {
        ...
        Function.prototype.bind || (Function.prototype.bind = function (n) {
            ...
            return r = c.call(arguments, 1),
                i = function () {
                    var f, e, u;
                    return this instanceof i ? (f = function () { },
                        f.prototype = t.prototype, e = new f, u = t.apply(e, r.concat(c.call(arguments))), Object(u) === u ? u : e) : t.apply(n, r.concat(c.call(arguments)))
                },
                i
        }),
    ...
    return r.addTest = function (n, t) {
        if (typeof n == "object") for (var u in n) e(n, u) && r.addTest(u, n[u]);
        else {
            if (n = n.toLowerCase(), r[n] !== i) return r;
            t = typeof t == "function" ? t() : t,
                typeof enableClasses != "undefined" && enableClasses && (b.className += " " + (t ? "" : "no-") + n),
                r[n] = t
        }
        return r
    },
    ...
    function (n, t) {
        function e(t, i) {
            i = i || {},
                classes = i.classes || {},
                fadeClass = classes.fade || f.classes.fade,
                i.fade = i.fade || t.className.indexOf(fadeClass) > -1,
                this.element = t,
        ...
        e.prototype = {
            ...
            getComputedStyle: function (n) {
                var r = {},
                    e = {},
                    i, o, u, f;
                for (r = t.getComputedStyle(n, null), i = 0, o = r.length; i < o; i++) u = r[i],
                    f = r.getPropertyValue(u),
                    e[u] = f;
                return e
            },
            extractUrl: function (n) {
                ...
                return startRegex = /^url\(["']?/,
                    endRegex = /["']?\)$/,
                    t = n.replace(startRegex, "").replace(endRegex, "")
            },
            positionToNegativeMargin: function (n) {
                var r, i, t;
                return r = n.match(/^(-?\d+\S+)/)[0],
                    i = n.match(/\s(-?\d+\S+)$/)[0],
                    t = "margin:" + i + " 0 0 " + r
            },
            getBgSize: function (t, i) {
                ...
                return r = new Image,
                    r.src = t,
                    i !== "auto" && i !== "cover" && i !== "contain" && i !== "inherit" && (s = n(this.element), o = r.width / r.height, u = parseInt((i.match(/^(\d+)px/) || [0, 0])[1]), f = parseInt((i.match(/\s(\d+)px$/) || [0, 0])[1]), h = s.height() * o, c = s.width() / o, u = u || h, f = f || c),
                    e = u || f ? {
                        width: u,
                        height: f
                    } : {
            ...
            getBgParams: function (t) {
                var r = {},
                    i, u;
                return i = this.extractUrl(t.css("background-image")),
                    bgSize = this.getBgSize(i, t.css("background-size")),
                    offset = this.positionToNegativeMargin(t.css("background-position")),
                    r.styles = this.getComputedStyle(t[0]),
                    r.svg = n.extend({
                        url: i
                    },
                        bgSize, {
                ...
                t.handler = function (t) {
                    ...
                    if (this === t.target || !/textarea|select/i.test(t.target.nodeName) && (!n.hotkeys.options.filterTextInputs || !(n.inArray(t.target.type, n.hotkeys.textAcceptingInputTypes) > -1))) {
                        var f = t.type !== "keypress" && n.hotkeys.specialKeys[t.which],
                            ...
                            u = "",
                            e = {};
                        for (n.each(["alt", "ctrl", "shift"],
                            function (n, i) {
                                t[i + "Key"] && f !== i && (u += i + "+")
                            }), t.metaKey && !t.ctrlKey && f !== "meta" && (u += "meta+"), t.metaKey && f !== "meta" && u.indexOf("alt+ctrl+shift+") > -1 && (u = u.replace("alt+ctrl+shift+", "hyper+")), f ? e[u + f] = !0 : (e[u + s] = !0, e[u + n.hotkeys.shiftNums[s]] = !0, u === "shift+" && (e[n.hotkeys.shiftNums[s]] = !0)), o = 0, h = i.length; o < h; o++) if (e[i[o]]) return r.apply(this, arguments)
                    }
                }
            }
        }
    ...
    })(jQuery || this.jQuery || window.jQuery); (function (n) {
        ...
        t && (r = t.replace(/[tT]ransform/, "TransformOrigin"), r[0] == "T" && (r[0] = "t")),
            eval('IE = "v"=="\v"'),
            jQuery.fn.extend({
                rotate: function (t) {
                    var u, r, o, i, e, f;
                    if (this.length !== 0 && typeof t != "undefined") {
                        for (typeof t == "number" && (t = {
                            angle: t
                        }), u = [], r = 0, o = this.length; r < o; r++) i = this.get(r),
                            i.Wilq32 && i.Wilq32.PhotoEffect ? i.Wilq32.PhotoEffect._handleRotation(t) : (e = n.extend(!0, {},
                                t), f = new Wilq32.PhotoEffect(i, e)._rootObj, u.push(n(f)));
                        return u
                    }
                },
                getRotateAngle: function () {
                    for (var i = [], t, n = 0, r = this.length; n < r; n++) t = this.get(n),
                        t.Wilq32 && t.Wilq32.PhotoEffect && (i[n] = t.Wilq32.PhotoEffect._angle);
                    return i
                },
                stopRotate: function () {
                    for (var n, t = 0,
                        i = this.length; t < i; t++) n = this.get(t),
            ...
            Wilq32.PhotoEffect.prototype = {
                ...
                _animate: function () {
                    ...
                    r && !this._parameters.animatedGif ? clearTimeout(this._timer) : ((this._canvas || this._vimage || this._img) && (i = this._parameters.easing(0, t - this._animateStartTime, this._animateStartAngle, this._parameters.animateTo - this._animateStartAngle, this._parameters.duration), this._rotate(~~(i * 10) / 10)), this._parameters.step && this._parameters.step(this._angle), n = this, this._timer = setTimeout(function () {
                        ...
                        10)),
                        this._parameters.callback && r && (this._angle = this._parameters.animateTo, this._rotate(this._angle), this._parameters.callback.call(this._rootObj))
                },
                _rotate: function () {
                    var n = Math.PI / 180;
                    return IE ?
                        function (n) {
                            ...
                            function (n) {
                                this._angle = n,
                                    ...
                                    this._img.style[r] = this._parameters.center.join(" ")
                            } : function (t) {
                                this._angle = t,
                                    t = t % 360 * n,
    ...
    $("#nav-sec,#history").hover(function () {
        ...
        $("#tbBox").live({
            mousedown: function (n) {
                ...
                var i, t = $(document),
                    r = function (n) {
                        return t.scrollTop(t.scrollTop() + i - n.pageY),
                            !1
                    };
...
SMH.utils = function () {
    ...
    return {
        ...
        getRandomIndex: function (n) {
            ...
            for (var u = Math.random(), r = i.length - 1, t = 0; t < r;) if (probe = Math.ceil((r + t) / 2), i[probe] < u) t = probe + 1;
        ...
        imgRender: function (n, t) {
            ...
            $(n).attr("imgw", r),
                u ? (r > $(window).width() - 20 ? $(n).width($(window).width() - 20) : r < $("#mangaBox").width() && $(n).width($("#mangaBox").width()), $("#tool-zoom").removeClass().addClass("sel fit").text("适应")) : i != 0 && ($(n).width(r + r * i / 100), $("#tool-zoom").text((i > 0 ? "+" : "-") + $.formatNumber(Math.abs(i), {
                    format: "00"
                })).removeClass().addClass("sel zoom" + (i > 0 ? "in" : "out"))),
    ...
    SMH.imgData = function () {
        return function (n) {
            ...
            function e() {
                ...
                var u = n != null && t.block_cc.indexOf(n) < 0,
                    r = (h = (new Date).getHours(), h >= 20 || h < 8),
                    i = !navigator.cookieEnabled && t.block_cc == "";
                return u || r || i
            }
            var t = $.extend({},
                n),
            ...
            return u.push(pVars.curHost),
                {
                    init: function () {
                        if (this.writeList(), $.each(["autosize|0", "grayscale|0", "simple|0", "speed|1"],
                            function (n, t) {
                                var i = t.split("|");
                    ...
                    preInit: function () {
                        SMH.utils.init(this),
                            $.each(["bid", "cid", "len", "prevId", "nextId"],
                                function (n, i) {
                                    cInfo[i] = t[i]
                                }),
                    ...
                    getHost: function () {
                        ...
                        try {
                            i = SMH.store.get("imgServ"),
                                ...
                                i == null ? (u = SMH.utils.getRandomIndex(servs[pVars.curServ].hosts), SMH.store.set("imgHost", u), pVars.curHost = u) : (n = parseInt(i), n >= 0 && n < servs[pVars.curServ].hosts.length && (pVars.curHost = n)),
                                pVars.manga.filePath = SMH.utils.getPath(servs[pVars.curServ].hosts[pVars.curHost].h, t.path),
                                i = SMH.store.get("pageFunc"),
                                i == null ? (r = sys.mobile ? 2 : 1, SMH.store.set("pageFunc", r), pVars.curFunc = r) : (n = parseInt(i), n >= 0 && n < pfuncs.length && (pVars.curFunc = n))
                        } catch (f) { }
                    },
                    writeList: function () {
                        var i, n, f, r, u;
                        for (this.getHost(), i = [], n = 0, f = servs.length; n < f; n++) r = n == pVars.curServ ? ['class="current"', ""] : ["", ""],
                            i.push('<li><a href="javascript:void(0)" ' + r[0] + ' onclick="SMH.setServ(' + n + ')">' + r[1] + servs[n].name + "</a></li>");
                        for ($("#servList ul").append(i.join("")), i = [], n = 0, f = pfuncs.length; n < f; n++) r = n == pVars.curFunc ? ['class="current"', ""] : ["", ""],
                    ...
                    loadIMG: function () {
                        ...
                        c(function () {
                            $("span.nopic,#erroraudit_show").remove(),
                                $("#imgLoading").show(),
                                pVars.curFile = n.getPicUrl(pVars.page - 1),
                    ...
                    preload: function () {
                        for (var i, n = 1; n <= pVars.manga.preLoadNumber; n++) {
                            ...
                            i = this.getPicUrl(pVars.page - 1 + n),
                                s(i)
                        }
                    },
                    moreLoad: function (n) {
                        ...
                        function l() {
                            ...
                            return $("#mangaMoreBox img").each(function (n) {
                                if (u += $(this).height(), u > e) {
                                    var f = i + n - 2;
                                    return f = f > i ? f : i,
                                        r = f < t.files.length ? f : t.files.length - 1,
                                        !1
                                }
                            }),
                                r
                        ...
                        if (pVars.page != t.files.length && e()) {
                            ...
                            var u = -1,
                                p = setInterval(function () {
                                    ...
                                    i + r + 6e3 >= n.offset().top + n.height() && $.preLoadImg(f.getPicUrl(u),
                                        function () {
                                            s()
                                        })
                                },
        ...
        return i.push(pVars.curHost),
            {
                ...
                preload: function () {
                    for (var t, n = 1; n <= pVars.manga.preLoadNumber; n++) {
                        ...
                        t = SMH.imgData.getPicUrl(pVars.page - 1 + n),
                            f(t)
                    }
                },
                success: function (i) {
                    SMH.utils.imgRender("#mangaFile", !0),
                        ...
                        t > 1 && SMH.store.set("imgHost", pVars.curHost),
                        this.preload()
                },
                error: function (f) {
                    var e = this;
        ...
        t.fn = t.prototype = {
            ...
            _init: function (i) {
                ...
                return r.$pb = e,
                    ...
                    r.opts = u,
                    r.offsetHeight = o.outerHeight() + f.outerHeight(),
                    r._bindEvent(),
                    r._setPbZindex(),
            ...
            _bindEvent: function (t) {
                ...
                i.$xBtn.length && i.$xBtn.click(function () {
                    ...
                    n(document).bind("keydown", "return",
                        function () {
                            i.$oBtn.click()
                        }).bind("keydown", "esc",
                            function () {
            ...
            setPos: function (n, t) {
                ...
                return n === "c" && (n = r.height() - u.$pb.outerHeight(), n = n > 0 ? f + (n >> 1) - (n >> 3) : 0),
                    t === "c" && (t = r.width() - u.$pb.outerWidth(), t = t > 0 ? e + (t >> 1) : 0),
                    u.$pb.css({
                        top: n,
                        left: t
                    }),
            ...
            setContent: function (n) {
                ...
                if (typeof n == "string") t.$cont.html(n);
                    ...
                    t._elemBack = function () {
                        r.length ? r.after(n) : i.length ? i.before(n) : u.length && u.append(n),
                            n.css("display", f),
                            t._elemBack = null
                    },
                        t.$cont.append(n)
    ...
    SMH.pager = function (n) {
        ...
        if (r[1] < n.pc) for (n.pc - n.nee > r[1] && i.push("<span>...</span>"), f = Math.max(n.pc - n.nee, r[1]), t = f; t < n.pc; t++) u(t);
    ...
    function (n, t) {
        ...
        function r() {
            ...
            return (t("#fdType li").each(function () {
                ...
                n.errors = i.join(","), n.bookid = cInfo.bid, n.chapterid = cInfo.cid, n.content = t("#fdCont").val(), n.contact = t("#fdContact").val(), n.url = window.location.href, n.img = t("#mangaFile").attr("src"), t.ajax({
                    type: "POST",
    ...
    SMH.chapter = function () {
        ...
        function r(r) {
            console.log(r),
                u(2e3),
                t.show(r === 1 ? n.tip_next : n.tip_prev),
                i && clearTimeout(i),
                r === 1 ? cInfo.nextId == 0 ? (t.hide(), t.alert(cInfo.finished == 0 ? n.tip_last : n.tip_end)) : location.href = "/comic/" + cInfo.bid + "/" + cInfo.nextId + ".html" : cInfo.prevId == 0 ? t.hide(n.tip_first, 2e3) : location.href = "/comic/" + cInfo.bid + "/" + cInfo.prevId + ".html"
        }
        var n = {
    ...
    SMH.shortcuts = function () {
        ...
        return {
            init: function () {
                ...
                r = n == null || n == undefined ? 1 : n,
                    r == 1 ? (t(), $("#tip-shortcuts").show().delay(3e3).hide(500), SMH.store.set("tip-again", 0)) : i()
            }
        }
    }(),
                    ...
                    onstatechange: function (n) {
                        ...
                        SMH.store.get("autosize") && n != 0 && (i.attr("checked", !1), SMH.store.remove("autosize"), $("#mangaBox img,#mangaMoreBox img").each(function (n, t) {
                            ...
                            i.is(":checked") || (t = parseInt(n), Math.abs(t) < 100 && (SMH.store.set("zoom", t), r = $(this), $("#mangaBox img,#mangaMoreBox img").each(function (n, i) {
                                ...
                                $(i).width(r + r * t / 100),
                                    t == 0 ? ($("#tool-zoom").removeClass("sel"), $("#tool-zoom").text("缩放")) : $("#tool-zoom").text((t > 0 ? "+" : "-") + $.formatNumber(Math.abs(t), {
                                        format: "00"
    ...
    SMH.history = function () {
        ...
        return {
            ...
            add: function (t) {
                this.get(),
                    t != null && typeof t != "undefined" && ($.each(n.cvalue,
                        function (i) {
                            if (this.bid == t.bid) return n.cvalue.splice(i, 1),
                                n.len-- ,
                                !1
            ...
            format: function () {
                ...
                this.get(),
                    n.init = !0,
                    r = [],
                    n.len > 0 && $.each(n.cvalue,
                        function (i, u) {
                            var f = [];
                            f.push('<li><a class="hDelete fr" title="删除" rel="' + i + '"><span>删除</span></a>'),
                                ...
                                i == n.cvalue.length - 1 ? f.push('<span class="hTime">正在浏览观看……</span>') : f.push('<span class="hTime">上次于 ' + t(u.t) + " 观看</span>"),
                                f.push("</div></li>"),
                                r.push(f.join(""))
                        }),
                    u = this,
                    i = n.len,
                    i == 0 ? $("#hList").html('<div class="hNone">暂时没有观看记录!</div>') : ($("#hList").html('<div class="hList"><ul>' + r.reverse().join("") + "</ul></div>"), $(".hList li").hover(function () {
    ...
    $(function () {
        $(".nav-sec").html('<ul><li><a href="/list/japan/">日本</a></li><li><a href="/list/hongkong/">港台</a></li><li><a href="/list/other/">其它</a></li><li><a href="/list/europe/">欧美</a></li><li><a href="/list/china/">内地</a></li><li><a href="/list/korea/">韩国</a></li><li><a href="/list/rexue/">热血</a></li><li><a href="/list/maoxian/">冒险</a></li><li><a href="/list/mohuan/">魔幻</a></li><li><a href="/list/shengui/">神鬼</a></li><li><a href="/list/gaoxiao/">搞笑</a></li><li><a href="/list/mengxi/">萌系</a></li><li><a href="/list/aiqing/">爱情</a></li><li><a href="/list/kehuan/">科幻</a></li><li><a href="/list/mofa/">魔法</a></li><li><a href="/list/gedou/">格斗</a></li><li><a href="/list/wuxia/">武侠</a></li><li><a href="/list/jizhan/">机战</a></li><li><a href="/list/zhanzheng/">战争</a></li><li><a href="/list/jingji/">竞技</a></li><li><a href="/list/tiyu/">体育</a></li><li><a href="/list/xiaoyuan/">校园</a></li><li><a href="/list/shenghuo/">生活</a></li><li><a href="/list/lizhi/">励志</a></li><li><a href="/list/lishi/">历史</a></li><li><a href="/list/weiniang/">伪娘</a></li><li><a href="/list/zhainan/">宅男</a></li><li><a href="/list/funv/">腐女</a></li><li><a href="/list/danmei/">耽美</a></li><li><a href="/list/baihe/">百合</a></li><li><a href="/list/hougong/">后宫</a></li><li><a href="/list/zhiyu/">治愈</a></li><li><a href="/list/meishi/">美食</a></li><li><a href="/list/tuili/">推理</a></li><li><a href="/list/xuanyi/">悬疑</a></li><li><a href="/list/kongbu/">恐怖</a></li><li><a href="/list/sige/">四格</a></li><li><a href="/list/zhichang/">职场</a></li><li><a href="/list/zhentan/">侦探</a></li><li><a href="/list/shehui/">社会</a></li><li><a href="/list/yinyue/">音乐</a></li><li><a href="/list/wudao/">舞蹈</a></li><li><a href="/list/zazhi/">杂志</a></li><li><a href="/list/heidao/">黑道</a></li><li><a href="/list/shaonv/">少女</a></li><li><a href="/list/shaonian/">少年</a></li><li><a href="/list/qingnian/">青年</a></li><li><a href="/list/ertong/">儿童</a></li><li><a href="/list/tongyong/">通用</a></li></ul>'),
            ...
            function () {
                ...
                n(),
                    $(window).bind("scroll resize", SMH.utils.throttle(n, 200))
            }()
    });